...
st.sidebar.image('/content/Data/App_icon.png')

# Main page title and introduction
st.markdown("<h1 style='text-align: center;'>Restaurant Recommender</h1>", unsafe_allow_html=True)
...
image = Image.open('/content/Data/food_cover.jpg')
...
# Recommendation function based on 'Type'
def recom(dataframe, name):
    ...
    if title in dataframe['Name'].values:
        ...
        if reviews == '4.5 of 5 bubbles':
            image = Image.open('/content/Data/Ratings/Img4.5.png')
            st.image(image, use_column_width=True)
        elif reviews == '4 of 5 bubbles':
            image = Image.open('/content/Data/Ratings/Img4.0.png')
            st.image(image, use_column_width=True)
        elif reviews == '5 of 5 bubbles':
            image = Image.open('/content/Data/Ratings/Img5.0.png')
            st.image(image, use_column_width=True)
        else:
            pass
    ...
    st.text("")
    image = Image.open('/content/Data/food_2.jpg')
    st.image(image, use_column_width=True)
...
if st.button('Submit Feedback'):
    ...
    feedback_file = '/content/Data/feedback.csv'
